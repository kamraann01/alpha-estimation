...
export default function TrustBadges() {
  return (
    <section className="py-14 border-y border-white/[0.07] bg-[#0c2140] relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_50%,rgba(0,196,180,0.04),transparent)]" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {badges.map((b, i) => (
            <motion.div
              ...
              className="flex flex-col items-center text-center p-4 rounded-xl bg-white/[0.02] border border-white/[0.08] hover:border-teal-400/20 transition-colors"
            >
              <div className="w-10 h-10 rounded-xl bg-teal-400/10 border border-teal-400/20 flex items-center justify-center mb-3">
