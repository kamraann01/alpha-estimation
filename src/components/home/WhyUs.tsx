      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-blue-500 font-semibold text-sm uppercase tracking-wider mb-3">Why Alpha Estimation</p>
            ...
            {/* Callout stat */}
            <div className="relative rounded-2xl p-6 overflow-hidden bg-gradient-to-br from-blue-500/10 to-transparent border border-blue-500/20">
              ...
              <div className="absolute bottom-0 left-0 w-20 h-20 bg-blue-500/5 rounded-full translate-y-1/2 -translate-x-1/2 pointer-events-none" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {reasons.map((r, i) => (
              <motion.div
                ...
                className="glass rounded-xl p-5 hover:border-blue-500/25 hover:bg-white/[0.04] transition-all duration-200 group"
              >
                <div className="w-8 h-8 rounded-lg bg-blue-500/10 border border-blue-500/20 flex items-center justify-center mb-3 group-hover:bg-blue-500/15 transition-colors">
